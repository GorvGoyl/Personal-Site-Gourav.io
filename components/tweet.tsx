...
export function Tweet({
  ...
  return (
    <div className="rounded border no-underline border-gray-300 dark:border-gray-800 px-6 py-4 my-4 w-full">
      <div className="flex items-center">
        <a
          className="flex h-12 w-12 no-underline"
          href={authorUrl}
          target="_blank"
      ...
      <a
        className="text-gray-500 text-sm hover:underline no-underline"
        href={tweetUrl}
        target="_blank"
        rel="noopener noreferrer"
      >
